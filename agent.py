...
class Agent:
    def __init__(self, gamma, epsilon, lr, input_dims, batch_size, n_actions,
                 max_mem_size=100000, eps_end=0.01, eps_decay=5e-4):
        self.gamma = gamma
        ...
        self.Q_eval = DeepQNet(self.lr, n_actions=n_actions, input_dims=input_dims,
                               hidden1_dims=128, hidden2_dims=128)
